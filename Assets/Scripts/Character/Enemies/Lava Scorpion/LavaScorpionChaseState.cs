...
public class LavaScorpionChaseState : BaseState
{
    ...
    public override void LogicUpdate()
    {
        ...
        if (Mathf.Abs(currentEnemy.transform.position.x - GameObject.FindGameObjectWithTag("Player").transform.position.x) <= 5f)
        {
