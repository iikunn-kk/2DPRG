...
public class IceSnowMushroomsChaseState : BaseState
{
    ...
    public override void LogicUpdate()
    {
        ...
        if (Mathf.Abs(currentEnemy.transform.position.x - GameObject.FindGameObjectWithTag("Player").transform.position.x) <= 2.5f)
        {
